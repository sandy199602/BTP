...
public partial class print : System.Web.UI.Page
{
    ...
    protected void book(object sender, EventArgs e)
    {
        try
        {
            ...
            string query = "insert into ticket ([passenger name],age,mobile,seats,gender)values('"+name.Text+"','"+age.Text+"','"+mobile.Text+"','"+seat.Text+"','"+DropDownList1.SelectedItem.Value+"')";
